...
Report bugs at https://github.com/andreasm80/netbox-run-anta-plugin/issues.
...
NetBox Run Anta Plugin could always use more documentation, whether as part of the
official NetBox Run Anta Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/andreasm80/netbox-run-anta-plugin/issues.
...
Ready to contribute? Here's how to set up `netbox-run-anta-plugin` for local development.

1. Fork the `netbox-run-anta-plugin` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/netbox-run-anta-plugin.git
    ```
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com/andreasm80/netbox-run-anta-plugin/actions
