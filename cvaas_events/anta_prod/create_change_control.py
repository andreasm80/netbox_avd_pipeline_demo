    ...
    try:
        with create_grpc_channel(CVAAS_SERVER, API_TOKEN, CERT_FILE) as channel:
            ...
            if pending_task_ids:
                ...
                # Step 4: Approve the change control
                approveCC(channel, cc_id, ts)
                
                # Step 5: Execute the change control
        ...
        if e.code() == grpc.StatusCode.UNAUTHENTICATED:
            ...
            logging.error("Please ensure the 'action_id' variable is set to a valid action name from your CVaaS environment.")
        else:
