...
def main(args):
    ...
    json_request = json.dumps({"partialEqFilter":[{"status":0,"approve":{"value":True},"start":{"value":True}}],"filter":{"deviceIds":{"values":["2AB9BDD18A71C07B6A8A953AD88601E1","2E85018A64223A538DF7998034B03EDC","4F29E152080FCEFB29DB756B4F2C3577","9AAEE15EEB3A18FADDA20C1BACDB76F8","9CDD2323393E14468FC22C4AF1F1D99B","B52C1D9B0CA30A90F2A9E7046D573EE6","BBF97A93C142AB9A11F2C3358FAA6A8C","CEEEDE54D6FC6582BC75FF7E2B8FCE2D","D264759BAB01E3100E3A85704B65CBA1","F61379FA1B345E2FFDD5FB1B156FB329"]}}})
    ...
    with grpc.secure_channel(args.server, connCreds) as channel:
        ...
        print(list(tag_stub.Subscribe(req, timeout=RPC_TIMEOUT)))
